...
module.exports = {
    ...
    async execute(message, args) {
        ...
        - Minimal dalam 1 Minggu 3x Ikut kegiatan dan jika berhalangan bisa izin di [「💌」𝗖𝗵𝗮𝘁-𝗖𝗮𝘀𝘁𝗶𝗹𝗹𝗮-𝗠𝗼𝘅𝗶𝗲](https://discord.com/channels/1220021811325042768/1381949017780518995). **Tidak ada izin tertulis/tidak mau ikut aturan ini dipersilakan meninggalkan kelompok ini.** (*Punishment Kick/Demoted dari kelompok*)
        ...
        - Wajib menjaga kehormatan keluarga kapanpun dan dimanapun. (*Punishment ditusuk/disiksa lalu diinterogasi*)
